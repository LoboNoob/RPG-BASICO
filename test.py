...
while True:
    ...
    if opcoes == 1:
        ...
        print("Chegando lá você se depara com algumas pessoas nada normais")
        print("Toge inumaki")
        print("Panda (Sim um Panda).")
        print("Nobara Kugisaki")
        input("APERTE ENTER")
        print("")
        print("Após se apresentar a eles você se senta para aprender com o professor que está chegando ainda")
        print("No momento em que ele chega, ele já se apresenta para você")
        print("Seu nome é Satoru Gojo")
        print("TIME SKIP...")
        print(" ")
        print("Ele te explicou como funciona o mundo, como funciona as inatas e muitas outras coisas")
        print("Graças a isso, você percebeu que precisa ficar mais forte")
        print("Chegando na sua casa você já faz as preparações para iniciar um longo treinamento que durará um tempo indeterminado")
        print("Sem isso você será só mais um entre todos...")
        input("PROSSEGUIR?")
        print("...")
        print("Se passaram 5 meses, você frequentou a escola normalmente e fez alguns tipos de treinos")
        print("Aumentando em muito a sua força e inteligencia")
        print("Graças a isso aprendeu mais sobre sua inata, Liberando até mesmo algumas de suas habilidades")
        print("Porém nem tudo é um mar de rosas não é mesmo?")
        print("Sua escola foi sorteada para limpar uma area em que varias maldições se agruparam")
        print("E isso aconteceu pelo fato de Satoru Gojo ter desaparecido nos ultimos meses em que você ficou treinando")
        print("Com isso você irá se encontrar com o pessoal da sua escola para irem até lá")
        print("...")
        print("Chegando lá vocês são levados em onibus para que todos consigam ir sem se cansar")
        input("APERTE ENTER")
        print("...")
        print("Agora vocês serão divididos em grupos de 3 pessoas e com o pessoal da sua classe")
        print("Obviamente você ficou com o Panda,Inumaki e Nobara")
        print("Após isso vocês foram mandados para irem para o Sul da cidade, Aonde tem menos maldições")
        print("Consideraram vocês os mais fracos por conta disso foram mandados para lá")
        print("Nobara disse o seguinte: --Espero que vocês dois não me atrapalhem fracotes.")
        print("Panda nem ligou")
        print("Você quer retrucar?")
        retrucar = int(input("1-Sim 2-Não"))
        if retrucar == 1:
            print("Nobara olha para você e te chama novamente de fracote ferrado agora")
            print("Você percebe que não adianta retrucar")
        else:
            print("Ok vamos continuar...")
        print("Após esse desaforo você vai indo seguindo seus companheiros para o Sul da cidade")
        print("passando 20 min...")
        print("Uma maldição de nivel 5 Apareceu")
        print("Vale lembrar que quanto menor a classificação da maldição mais forte ela é")
        print("Indo de 5-1 e dps vem os classe especial Ou chamados S ")
        print("para exorcizar uma maldição de nivel Special por exemplo você precisaria ser classe 1 no minimo")
        print("...Você é classe 5 ainda...")
        print("Mas ainda bem que é uma maldição apenas de classe 5")
        input("APERTE ENTER PARA PROSSEGUIR")
        print("...")
        print("Seus companheiros querem te testar, colocaram você sozinho para ganhar dessa maldição")
        print("Você não tem outra opção a não ser entrar no joguinho deles")
        print("Entrando no combate...") #2 combate contra a maldição classe 5
